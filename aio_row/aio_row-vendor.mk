...
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,vendor/lenovo/aio_row/proprietary/bin,system/bin)

PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,vendor/lenovo/aio_row/proprietary/etc,system/etc)

PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,vendor/lenovo/aio_row/proprietary/lib,system/lib)
